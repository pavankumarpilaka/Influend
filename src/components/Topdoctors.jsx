...
const Topdoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-6 text-grey-900 md:mx-10'>
      ...
      <p className='sm:w-1/3 text-center text:sm'>Connection With great Doctors is a Click Away.. </p>  
      ...
      <button onClick={()=>{navigate('/doctors');scrollTo(0,0)}} className='bg-blue-50 text-grey-600 px-12 rounded-full mt-15'>More</button>
    </div>
  )
}
